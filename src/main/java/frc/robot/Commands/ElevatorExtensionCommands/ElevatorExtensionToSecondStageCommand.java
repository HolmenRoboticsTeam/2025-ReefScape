...
public class ElevatorExtensionToSecondStageCommand extends Command {

  private ElevatorExtensionSubsystem m_elevatorExtension;

  private boolean m_allowEndCondition;

  /** Creates a new ElevatorExtensionToSecondStageCommand. */
  public ElevatorExtensionToSecondStageCommand(ElevatorExtensionSubsystem elevatorExtension, boolean allowEndCondition) {
  ...
  public void execute() {
    ...
    this.m_elevatorExtension.setTargetExtension(ElevatorExtensionConstants.kSecondStageTrip);
  }
  ...
  public boolean isFinished() {
    double positionError = Math.abs(this.m_elevatorExtension.getCurrentExtension() - ElevatorExtensionConstants.kSecondStageTrip);
