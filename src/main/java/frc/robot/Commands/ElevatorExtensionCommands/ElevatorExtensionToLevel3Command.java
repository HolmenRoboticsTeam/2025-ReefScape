...
public class ElevatorExtensionToLevel3Command extends Command {
  ...
  public ElevatorExtensionToLevel3Command(ElevatorExtensionSubsystem elevatorExtension, boolean allowEndCondition) {
  ...
  public void execute() {
    ...
    this.m_elevatorExtension.setTargetExtension(ElevatorExtensionConstants.kLevel3Extend);
  }
  ...
  public boolean isFinished() {
    double positionError = Math.abs(this.m_elevatorExtension.getCurrentExtension() - ElevatorExtensionConstants.kLevel3Extend);
