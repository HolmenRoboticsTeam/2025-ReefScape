...
public class ElevatorExtensionToLevel1Command extends Command {
  ...
  public ElevatorExtensionToLevel1Command(ElevatorExtensionSubsystem elevatorExtension, boolean allowEndCondition) {
  ...
  public void execute() {
    ...
    this.m_elevatorExtension.setTargetExtension(ElevatorExtensionConstants.kLevel1Extend);
  }
