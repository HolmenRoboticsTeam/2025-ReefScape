...
public class GripperPivotToCoralStationCommand extends Command {

  private GripperPivotSubsystem m_gripperPivot;
  private boolean m_allowEndCondition;

  /** Creates a new GripperPivotToCoralStationCommand. */
  public GripperPivotToCoralStationCommand(GripperPivotSubsystem gripperPivot, boolean allowEndCondition) {
  ...
  public void execute() {
    ...
    this.m_gripperPivot.setTargetAngle(GripperPivotConstants.kCoralStationAngle);
  }
