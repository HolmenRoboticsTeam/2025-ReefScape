...
public class GripperPivotToLevel4Command extends Command {

  private GripperPivotSubsystem m_gripperPivot;
  private boolean m_allowEndCondition;

  /** Creates a new GripperPivotToLevel1Command. */
  public GripperPivotToLevel4Command(GripperPivotSubsystem gripperPivot, boolean allowEndCondition) {
  ...
  public void execute() {
    ...
    this.m_gripperPivot.setTargetAngle(GripperPivotConstants.kLevel4Angle);
  ...
  public boolean isFinished() {
    double angleError = Math.abs(this.m_gripperPivot.getCurrentAngle() - GripperPivotConstants.kLevel4Angle);
