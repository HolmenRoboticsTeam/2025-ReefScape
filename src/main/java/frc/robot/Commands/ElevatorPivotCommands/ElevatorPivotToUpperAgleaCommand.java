...
public class ElevatorPivotToUpperAgleaCommand extends Command {
  ...
  public ElevatorPivotToUpperAgleaCommand(ElevatorPivotSubsystem elevatorPivot, boolean allowEndCondition) {
  ...
  public void execute() {
    ...
    this.m_elevatorPivot.setTargetAngle(ElevatorPivotConstants.kUpperAlgeaRemove);
  }
  ...
  public boolean isFinished() {
    double positionError = Math.abs(this.m_elevatorPivot.getCurrentAngle() - ElevatorPivotConstants.kUpperAlgeaRemove);
