...
public class ElevatorPivotToLevel3Command extends Command {
  ...
  public void execute() {
    ...
    this.m_elevatorPivot.setTargetAngle(ElevatorPivotConstants.kLevel3Angle);
  }
  ...
  public boolean isFinished() {
    double positionError = Math.abs(this.m_elevatorPivot.getCurrentAngle() - ElevatorPivotConstants.kLevel3Angle);
