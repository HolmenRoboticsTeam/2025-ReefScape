...
public class ElevatorPivotToLevel2Command extends Command {
  ...
  public ElevatorPivotToLevel2Command(ElevatorPivotSubsystem elevatorPivot) {
  ...
  public void execute() {
    ...
    elevatorPivot.setTargetAngle(ElevatorPivotConstants.kLevel2Angle);
    elevatorPivot.setTargetExtension(ElevatorExtensionConstants.kLevel2Extend);
  }
  ...
  public boolean isFinished() {
    double angleError = Math.abs(elevatorPivot.getCurrentAngle() - ElevatorPivotConstants.kLevel2Angle);
    double extensionError = Math.abs(elevatorPivot.getCurrentExtension() - ElevatorExtensionConstants.kLevel2Extend);
