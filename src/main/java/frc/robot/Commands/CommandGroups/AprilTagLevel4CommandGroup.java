...
public class AprilTagLevel4CommandGroup extends SequentialCommandGroup {
  /** Creates a new AprilTagLevel2Command. */
  public AprilTagLevel4CommandGroup(CommandXboxController controller, DriveSubsystem drive, LimelightSubsystem limelight, ElevatorPivotSubsystem elevatorPivot,
