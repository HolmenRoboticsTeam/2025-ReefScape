...
public class AprilTagLevel3CommandGroup extends SequentialCommandGroup {
  /** Creates a new AprilTagLevel2Command. */
  public AprilTagLevel3CommandGroup(CommandXboxController controller, DriveSubsystem drive, LimelightSubsystem limelight, ElevatorPivotSubsystem elevatorPivot,
  ElevatorExtensionSubsystem elevatorExtension, GripperPivotSubsystem gripperPivot, GripperIntakeSubsystem gripperIntake) {
    ...
    addCommands(
      new FrontReefLineUpCommand(drive, limelight),
