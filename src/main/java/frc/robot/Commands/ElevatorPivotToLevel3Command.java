...
public class ElevatorPivotToLevel3Command extends Command {
  ...
  ElevatorPivotSubsystem elevatorPivot;

  /** Creates a new ElevatorPivotToLevel1Command. */
  public ElevatorPivotToLevel3Command(ElevatorPivotSubsystem elevatorPivot) {
  ...
  public void execute() {
    ...
    elevatorPivot.setTargetAngle(ElevatorPivotConstants.kLevel3Angle);
    elevatorPivot.setTargetExtension(ElevatorExtensionConstants.kLevel3Extend);
  }
  ...
  public boolean isFinished() {
    double angleError = Math.abs(elevatorPivot.getCurrentAngle() - ElevatorPivotConstants.kLevel3Angle);
    double extensionError = Math.abs(elevatorPivot.getCurrentExtension() - ElevatorExtensionConstants.kLevel3Extend);
