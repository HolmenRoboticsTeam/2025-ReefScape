...
public final class MotorConfigs {
    ...
    public static final class ElevatorExtensionConfig {
        ...
        static {
            ...
            //0.02425 is r (2.0 * Math.PI * 0.02425) = 0.15236724 meters, 0.16269 seems to be a better conversion?
            ...
            leftExtensionConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(ElevatorExtensionConstants.kMaxCurrentLimit).voltageCompensation(ElevatorExtensionConstants.kMaxVoltage);
            rightExtensionConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(ElevatorExtensionConstants.kMaxCurrentLimit).voltageCompensation(ElevatorExtensionConstants.kMaxVoltage);
        }
    }
    ...
    public static final class GripperPivotConfig {
        ...
        static {
            ...
            pivotConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(GripperPivotConstants.kMaxCurrentLimit).voltageCompensation(GripperPivotConstants.kMaxVoltage);
        }
    }
    ...
    public static final class GripperIntakeConfig {
        ...
        static {
            ...
            intakeConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(GripperIntakeConstants.kMaxCurrentLimit).voltageCompensation(GripperIntakeConstants.kMaxVoltage);
        }
    }
}
